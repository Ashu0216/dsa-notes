...
│                       Algorithm                              │
├──────────────────────────────────────────────────────────────┤
│  1. Apply Merge Sort (divide array into two halves)          │
│  2. Recursively count inversions in left half                │
│  3. Recursively count inversions in right half               │
│  4. During merge step:                                       │
│       - If left[i] <= right[j] → no inversion                │
│       - Else → (n1 - i) inversions (cross inversions)        │
│  5. Sum left + right + cross inversions                      │
│                                                              │
│  Idea : Count cross inversions while merging sorted halves   │
│         Efficiently counts multiple inversions at once       │
╰──────────────────────────────────────────────────────────────╯
*/
...
│  Space : O(N)                                                │
│--------------------------------------------------------------│
│  Note  : Merge sort recursion depth = log N                  │
