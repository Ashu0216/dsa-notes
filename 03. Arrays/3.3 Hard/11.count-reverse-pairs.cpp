...
│                       Algorithm                              │
├──────────────────────────────────────────────────────────────┤
│  1. Apply Merge Sort (divide array recursively)              │
│  2. Count reverse pairs in left half                         │
│  3. Count reverse pairs in right half                        │
│  4. Before merging, count cross pairs:                       │
│       - For each i in left half                              │
│       - Move pointer j in right half while                   │
│         arr[i] > 2 * arr[j]                                  │
│       - Add (j - (mid + 1)) to count                         │
│  5. Merge the two sorted halves normally                     │
│                                                              │
│  Idea : Use sorted halves to count multiple pairs            │
│         efficiently during merge step                        │
╰──────────────────────────────────────────────────────────────╯
*/
